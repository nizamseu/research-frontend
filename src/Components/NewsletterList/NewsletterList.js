...
const NewsletterList = () => {
  ...
  React.useEffect(() => {
    axios
      .get(`https://research-backend-production.up.railway.app/newsletter`)
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://research-backend-production.up.railway.app/newsletter/${id}`
          )
  ...
  const handleStatus = (id, text, mark) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .put(
            `https://research-backend-production.up.railway.app/newsletterStatus/${id}`,
            {
              text: text,
            }
          )
