...
import "../WebDevCourses/WebDevCourses.css";

const WebDevCourses = () => {
  const [courses, setCourses] = useState([]);

  const webCategory = "Web Development";

  useEffect(() => {
    fetch(
      `https://research-backend-production.up.railway.app/WebDevCourses?particularCategory=${webCategory}`
    )
      .then((res) => res.json())
