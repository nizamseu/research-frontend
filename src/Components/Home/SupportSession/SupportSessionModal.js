...
const SupportSessionModal = ({ setSupportSessionModal }) => {
  ...
  const onSubmit = ({
    ...
    axios
      .post(
        `https://research-backend-production.up.railway.app/supportsession`,
        data
      )
              ...
              <div className="flex flex-col space-y-1">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <div className="flex justify-between">
                    <div className="p-5 w-40 bg-white rounded-lg shadow-xl">
                      <div className="my-2 font-bold">Start Time</div>
                      <div className="flex">
                        <select
                          name="startTimeHour"
                          {...register("startTimeHour", { required: true })}
                          className="text-center bg-transparent text-xl appearance-none outline-none"
                        >
