...
const StudentProfile = () => {
  ...
  React.useEffect(() => {
    axios
      .get(
        `https://research-backend-production.up.railway.app/allusers?email=${savedUser.email}`
      )
      .then((res) => {
        setUsers(res.data);
      });
  ...
  return (
    <div className="container mx-auto px-4 md:px-11">
        ...
        <div className=" w-full bg-white px-7 drop-shadow-xl  mb-7">
          ...
          <div className="mx-auto py-4">
            <div className="mx-auto ">
              ...
              >
                <img
                  src={users?.photoURL || savedUser.photoURL}
            ...
            <div className="mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
                <div className="my-2">
                  ...
                  <p>
                    {"std-" + users?._id?.slice(users?._id.length - 7) || "N/A"}
                  </p>
                </div>
                <div className="my-2">
                  <h2 className="text-lg">Full Name:</h2>
                  <p>{users?.fullname || savedUser.displayName || "N/A"}</p>
                </div>
                <div className="my-2">
                  <h2 className="text-lg">Email Address:</h2>
                  <p>{savedUser.email || "N/A"}</p>
                </div>
                <div className="my-2">
      ...
      {(!savedUser || !users) && <LoadingOverlay />}
    </div>
  );
};
