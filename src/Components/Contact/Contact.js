...
const Contact = () => {
  ...
  const onSubmit = ({ userName, email, subject, message }) => {
    ...
    setSubmitting(true);
    axios
      .post(`https://research-backend-production.up.railway.app/email`, data)
              ...
              <div>
                ...
                <div className="mt-4 flex gap-3">
                  <a
                    ...
                    className="bg-blue-300 hover:bg-blue-500 px-3 py-2 text-white inline-flex items-center space-x-2 rounded"
                  >
                    <FontAwesomeIcon
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-cyan-200 hover:bg-cyan-400 px-3 py-2 text-white inline-flex items-center space-x-2 rounded"
                  >
                    <FontAwesomeIcon
                      className="text-xl text-white"
                      icon={faTwitter}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-rose-300 hover:bg-rose-500 px-3 py-2 text-white inline-flex items-center space-x-2 rounded"
                  >
                    <FontAwesomeIcon
                      className="text-xl text-white"
                      icon={faPinterest}
