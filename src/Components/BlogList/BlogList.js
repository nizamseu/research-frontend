...
const BlogList = () => {
  ...
  React.useEffect(() => {
    axios
      .get(`https://research-backend-production.up.railway.app/blogs`)
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://research-backend-production.up.railway.app/blogs/${id}`
          )
  ...
  const handleStatus = (id, text, mark) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .put(
            `https://research-backend-production.up.railway.app/blogStatus/${id}`,
            {
              text: text,
            }
          )
